...
from src.links.core.interfaces.repositories.units_of_work.cache import IUnitOfWork
from src.links.infrastructure.storages.cache.repositories.link import LinkRepository


class UnitOfWork(IUnitOfWork):
    def __init__(self, client: Redis):
        self.client = client
        self.links = LinkRepository(client)
        self._pipeline = None
